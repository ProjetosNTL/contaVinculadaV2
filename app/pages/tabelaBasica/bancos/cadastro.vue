  ...
  <div class="p-6">
    ...
    <div class="bg-white rounded-lg shadow-md mb-6 p-4">
      <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
        <div>
          <label class="block text-sm font-medium text-gray-700 mb-1">Código do Banco <span class="text-red-500">*</span></label>
          <input v-model="form.codigoBanco" type="text" maxlength="11" class="w-full border rounded-md p-2" />
        </div>
        <div class="md:col-span-2">
          <label class="block text-sm font-medium text-gray-700 mb-1">Nome da Instituição <span class="text-red-500">*</span></label>
          <input v-model="form.nomeBanco" type="text" class="w-full border rounded-md p-2" />
        </div>
      </div>
    </div>
...
const gravar = async () => {
  if (!form.value.codigoBanco) return alert("Informe o código do banco")
  if (!form.value.nomeBanco) return alert("Informe o nome da instituição")
