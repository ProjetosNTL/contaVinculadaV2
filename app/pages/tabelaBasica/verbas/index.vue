<template>
  <div class="min-h-full flex flex-col gap-6 p-4 md:p-8 animate-fade-in text-gray-900 dark:text-gray-100">
    ...
    <AppCabecalhoPagina tituloFino="Tabela de" tituloGrosso="Verbas"
      descricao="Cadastro e gestão de rubricas e verbas do sistema" icone="fa7-solid:sack-dollar" />

    <AppBarraFerramentas v-model:visao-atual="visaoAtual" mostrar-relatorio @excel="gerarExcel" @pdf="gerarPdf">
      <template #entradas>
        <AppInputTexto v-model="filtro.descricao" placeholder="Buscar por nome da verba..." icone="fa7-solid:magnifying-glass"
          @enter="buscarLista" />
